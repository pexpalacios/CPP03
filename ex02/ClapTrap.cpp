...
/*   Updated: 2025/10/06 17:22:30 by penpalac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->EP > 0)
	{
		if (this->HP > 0)
		{
			...
			std::cout << "A dead ClapTrap cannot repair itself" << std::endl;
	}
	else
		std::cout << this->name << " has no energy to repair itsel" << std::endl;
};
